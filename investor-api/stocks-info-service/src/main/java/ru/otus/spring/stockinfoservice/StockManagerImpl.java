...
public class StockManagerImpl implements StockManager {
    ...
    public List<StockDto> getAllStocksOfLastDay() {
        try {
            ...
            producer.sendError(new ErrorMessage(e, "", "Ошибка при получении послдених данных об акциях " + LocalDateTime.now()));
    ...
    public void saveAll(List<StockDto> list) {
        try {
            ...
            producer.sendError(new ErrorMessage(e, "", "Ошибка при сохранении всех акций " + LocalDateTime.now()));
    ...
    public void clearCurrentTable() {
        try {
            ...
            producer.sendError(new ErrorMessage(e, "", "Ошибка при очистке таблицы с текущими значениями акций " + LocalDateTime.now()));
