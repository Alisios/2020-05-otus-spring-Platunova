...
insert into Comments(text, book_id) values ('Очень долгая', 4)
insert into Comments(text, book_id) values ('классика!', 3)
insert into Comments(text, book_id) values ('Сириус лучший', 2)
